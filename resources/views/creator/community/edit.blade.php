            ...
            <form action="{{ route('creator.community.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <img src="{{ asset('storage/' . $community->cover_image) }}"
                                    class="h-32 w-full object-cover rounded-lg mb-2 border">
                                @endif
                        ...
                        <div class="mt-6">
                            ...
                            <div class="flex items-center gap-2 mt-1">
                                <input type="color" name="accent_color"
                                    value="{{ old('accent_color', $community->accent_color ?? '#4F46E5') }}"
                ...
                <div class="bg-white shadow sm:rounded-lg mb-6">
                    <div class="p-6 border-b border-gray-200 space-y-4">
                        ...
                        <x-form.textarea name="description" label="Descrição / Bio" rows="4"
                            :value="old('description', $community->description)" maxlength="1000" />
                        ...
                        <div class="">
                            ...
                            <select name="category"
                                ...
                                <option value="{{ $cat }}"
                                    {{ old('category', $community->category) === $cat ? 'selected' : '' }}>
                                    {{ $cat }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="flex rounded-md shadow-sm mt-1">
                                    <span
                                        class="inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 text-gray-500 text-sm">instagram.com/</span>
                                    <input type="text" name="instagram_handle"
                                        value="{{ old('instagram_handle', $community->instagram_handle) }}"
                            ...
                            <div>
                                ...
                                <div class="flex rounded-md shadow-sm mt-1">
                                    <span
                                        class="inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 text-gray-500 text-sm">youtube.com/</span>
                                    <input type="text" name="youtube_handle"
                                        value="{{ old('youtube_handle', $community->youtube_handle) }}"
                                        class="flex-1 min-w-0 block w-full px-3 py-2 rounded-none rounded-r-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300">
                                </div>
                            </div>

                            <div class="md:col-span-2">
                                <x-input-label for="whatsapp_group"
                                    :value="__('Link do Grupo (WhatsApp/Telegram/Discord)')" />
                                <x-text-input id="whatsapp_group" name="whatsapp_group" type="url"
                                    class="mt-1 block w-full" :value="old('whatsapp_group', $community->whatsapp_group)"
